use crate::core::{Cli, run_main};
use crate::easytier_cli::{CommandHandler, InstanceSelectArgs, OutputFormat};
use crate::peers::peer_manager::PeerManager;
use crate::peers::rpc_service::PeerManagerRpcService;
use crate::proto::api::instance::{
    InstanceIdentifier, NodeInfo, PeerManageRpc, ShowNodeInfoRequest, list_peer_route_pair,
};
use crate::proto::rpc_impl::standalone::StandAloneClient;
use crate::proto::rpc_types::controller::BaseController;
use crate::tunnel::tcp::TcpTunnelConnector;
use crate::utils::PeerRoutePair;
use crate::utils::string::{cost_to_str, float_to_str};
use cidr::Ipv4Inet;
use clap::Parser;
...
lazy_static! {
    static ref g_isrunning: std::sync::RwLock<bool> = std::sync::RwLock::new(false);
}
...
pub(crate) fn is_running() -> bool {
    g_isrunning.read().unwrap().clone()
}

pub(crate) fn set_running_state(running: bool) {
    let mut guard = g_isrunning.write().unwrap();
    *guard = running;
}
...
pub fn remote_status() -> *mut u8 {
    ...
    let handler = CommandHandler {
        ...
        instance_selector: InstanceIdentifier { selector: None },
