...
pub(crate) struct Cli {
    ...
    #[command(flatten)]
    pub(crate) instance_select: InstanceSelectArgs,
...
pub struct CommandHandler<'a> {
    pub(crate) client: tokio::sync::Mutex<RpcClient>,
...
impl Service {
    pub fn new(name: String) -> Result<Self, Error> {
        ...
        let service_manager = Box::new(win_service_manager::WinServiceManager::new()?);
